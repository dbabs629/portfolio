...
export default function PortfolioPage() {
  ...
  let textList = [
    'I made my portfolio website to showcase my work and knowledge in software development. I graduated from Humber College with a diploma in Web Design and Interactive Media. I learned  about Web Design, User Experience, Front-end & Back-end Development. I chose Tailwindcss and React because it is fast to develop a project from scratch by creating reusable React components and using Tailwindcss’ utility classes. ',
